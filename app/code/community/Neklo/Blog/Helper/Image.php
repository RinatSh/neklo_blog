...
class Neklo_Blog_Helper_Image extends Mage_Core_Helper_Abstract
{
    ...
    public function uploadImage($scope)
    {
        ...
        if ($adapter->isUploaded($scope)) {
            ...
            if (!$adapter->isValid($scope)) {
                ...
                Mage::throwException(Mage::helper('neklo_blog/config')->__('Uploaded image is not valid'));
     ...
     *
     * @param Neklo_Blog_Model_Item $item
     * @param integer $width
     * @param integer $height
     * @return bool|string
     */

    public function resize(Neklo_Blog_Model_News $item, $width, $height = null)
    {
        if (!$item->getImage()) {
